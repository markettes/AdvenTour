            ...
            return GoogleMap(
              ...
              onTap: _handleTap,
                ...
                Future<void> _nearPlaces(LatLng point) async {
                  ...
                  var url =
                  'https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=' + point.latitude.toString() +
                  ',' + point.longitude.toString() + '&radius=50&key=' + apiKey;
                  ...
                  Place placeDef;
                  for (var place in places) {
                    var _distanceInMeters = Geolocator.distanceBetween(point.latitude, point.longitude, place.latitude, place.longitude);
                  ...
                  if (placeDef != null) { //debugging nombre place
                    PlacesDetailsResponse response = await placesGM.getDetailsByPlaceId(placeDef.id);
                    print("***********************");
