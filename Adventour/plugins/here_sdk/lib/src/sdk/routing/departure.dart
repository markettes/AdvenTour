...
class Departure {
  ...
  Departure(this.type, this.waypointIndex, this.originalCoordinates, this.mapMatchedCoordinates, this.chargeInKilowattHours, this.chargingStation);
...
Pointer<Void> sdk_routing_Departure_toFfi(Departure value) {
  ...
  final _result = _sdk_routing_Departure_create_handle(_type_handle, _waypointIndex_handle, _originalCoordinates_handle, _mapMatchedCoordinates_handle, _chargeInKilowattHours_handle, _chargingStation_handle);
